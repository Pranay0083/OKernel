...
export const OSConcepts = () => {
    ...
    const getTableOfContents = () => {
        ...
        if (path === '/os-concepts' || path === '/os-concepts/') {
            return [
                { id: 'monolithic', label: 'Monolithic' },
                { id: 'microkernel', label: 'Microkernel' },
                    ...
                    <div className="p-6 space-y-8">
                                        ...
                                        {section.items.map((item) => (
                                            <li key={item.path}>
                                                <NavLink 
                                                    ...
                                                    `}
                                                >
                                                    <span className={`transition-colors ${location.pathname === item.path ? 'text-blue-500' : 'text-zinc-600 group-hover:text-zinc-400'}`}>
                                                        {item.icon}
                                                    </span>
                                                    {item.title}
                        ...
                        <div className="pt-8 border-t border-zinc-800">
                            <div className="px-3">
                                ...
                                >
                                    Go to AlgoWiki <ArrowRight size={12} />
                                </NavLink>
                            </div>
                        </div>
                    </div>
