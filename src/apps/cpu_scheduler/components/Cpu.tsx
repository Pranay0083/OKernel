                ...
                <div className="w-[90%] h-[90%] relative z-10">
                    <AnimatePresence mode='wait'>
                        {runningProcess ? (
                            ...
                            >
                                {/* Header */}
                                <div className="flex justify-between items-start border-b border-white/5 pb-1 md:pb-2">
                                    <div className="flex flex-col">
                                        <span className="text-zinc-500 font-bold text-[8px] md:text-[9px] tracking-widest uppercase">ID</span>
                                        <span className="text-sm md:text-xl font-mono text-white tracking-widest font-bold leading-none mt-1">
                                            {1000 + runningProcess.id}
                                        </span>
                                    </div>
                                    <div className="flex flex-col items-end">
                                        <span className="text-zinc-500 font-bold text-[8px] md:text-[9px] tracking-widest uppercase">PRI</span>
                                        <div className="flex items-center gap-1.5 mt-1">
                                            ...
                                            <span className={`text-sm md:text-lg font-bold leading-none ${runningProcess.priority <= 2 ? 'text-red-500' : 'text-blue-500'}`}>
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center min-h-0">
                                    <div className="text-2xl md:text-4xl font-black text-white tracking-tighter truncate max-w-full">
                                        {runningProcess.name}
                                    </div>
                                ...
                                {/* Stats Grid */}
                                <div className="grid grid-cols-3 gap-px bg-white/5 border border-white/5 rounded overflow-hidden mb-2 md:mb-3">
                                    <div className="bg-zinc-900/80 p-1 md:p-2 text-center">
                                        <div className="text-[7px] md:text-[8px] text-zinc-500 font-bold uppercase">Arrival</div>
                                        <div className="text-[10px] md:text-xs font-mono text-zinc-300">{runningProcess.arrivalTime}</div>
                                    </div>
                                    <div className="bg-zinc-900/80 p-1 md:p-2 text-center">
                                        <div className="text-[7px] md:text-[8px] text-zinc-500 font-bold uppercase">Burst</div>
                                        <div className="text-[10px] md:text-xs font-mono text-zinc-300">{runningProcess.burstTime}</div>
                                    </div>
                                    <div className="bg-zinc-900/80 p-1 md:p-2 text-center">
                                        <div className="text-[7px] md:text-[8px] text-zinc-500 font-bold uppercase">Rem</div>
                                        <div className="text-xs md:text-sm font-mono text-white font-bold">{runningProcess.remainingTime}</div>
                                    </div>
                                </div>

                                {/* Progress Bar */}
                                <div className="space-y-1 md:space-y-1.5">
                                    <div className="flex justify-between text-[7px] md:text-[8px] text-zinc-500 font-bold uppercase tracking-wider">
                                        <span>Exec Buffer</span>
