    ...
    return (
        <Layout>
            <LayoutGroup>
                ...
                <div
                    className="h-auto lg:h-[calc(100vh-64px)] p-2 grid gap-2 bg-background overflow-y-auto lg:overflow-hidden font-mono text-sm"
                    style={{
                        display: 'grid',
                        gridTemplateColumns: 'repeat(12, 1fr)',
                        // On mobile/tablet, let rows auto-size. On Desktop, lock them.
                        gridTemplateRows: 'auto',
                    }}
                >
                    {/* Desktop-only style override to lock height */}
                    <style>{`
                        @media (min-width: 1024px) {
                            .grid-layout-lock {
                                grid-template-rows: 60px minmax(0, 1fr) 200px !important;
                            }
                        }
                    `}</style>
                    <div
                        className="grid-layout-lock col-span-12 grid grid-cols-12 gap-2 h-full w-full"
                        style={{ display: 'contents' }}
                    >

                        {/* Top Bar: Controls & Stats (Row 1) */}
                        <div className="col-span-12 h-[60px] bg-card border border-border rounded-lg flex items-center px-4 justify-between gap-4 overflow-hidden order-1">
                        ...
                        <div className="col-span-12 grid grid-cols-12 gap-2 min-h-0 order-2 lg:h-full h-[800px]">
                        ...
                        <div className="col-span-12 bg-card border border-border rounded-lg overflow-hidden flex flex-col shadow-sm">
